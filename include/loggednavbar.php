<nav class="flex items-center justify-between bg-blue-500 py-3 px-3">
    <a href="." class="text-white flex text-[20px] items-center">
        Ask<div class="_NAVBUBBLECHAT">Me</div>
    </a>
    <div class="text-white flex items-center">
        <div class="mr-2 flex items-center justify-between bg-blue-500 _NAVBAR">
            ...
            <a href="user.php" class="inline-flex items-center text-center py-2 px-3 mx-2">
        ...
        <div class="relative">
            ...
            <div class="hidden absolute right-[5px] top-[40px] w-48 rounded-md shadow-md bg-white border text-gray-800 _FLOATMENU">
