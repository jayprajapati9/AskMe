...
<body>
    ...
    <div class="w-full max-w-screen-md mx-auto py-6 px-3">
        <div class="flex items-start">
            <img src="https://wallpaperaccess.com/full/1261770.jpg" alt="" class="w-20 h-20 object-cover rounded-full">
            <div class="flex flex-col items-start ml-4">
                <span class="inline-flex items-baseline">
                    <p class="text-[18px] font-medium text-slate-800">John Doe</p>
                    <!-- <i class='bx bxs-badge-check ml-1 text-blue-500'></i> green-500 -->
                </span>
                <p class="text-gray-500 text-[14px]">@john_1201</p>
                <!-- <a href=""
                    class="bg-tranparent inline-flex items-center text-[14px] py-1 px-4 rounded mt-4 border border-green-500 bg-green-500 text-white">
                    Following</a> -->
                <a href=""
                    class="bg-tranparent inline-flex items-center text-[14px] py-1 px-4 rounded mt-4 border border-blue-500 text-blue-500">
